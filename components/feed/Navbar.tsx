      ...
      <div className="container _custom_container">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
            ...
            <li className="nav-item _header_nav_item">
              <span
                ...
                onClick={() => setNotifyDropOpen(prev => !prev)}
              ...
              >
                ...
                <div className={`_notification_dropdown ${notifyDropOpen ? 'show' : ''}`}>
                  ...
                  <div className="_notifications_drop_box">
                    ...
                    <div className="_notifications_all">
                      ...
                      <div className="_notification_box">
                        ...
                        <div className="_notification_txt">
                          <p className="_notification_para">
                            An admin changed the name of the group <span className="_notify_txt_link">Freelancer USA</span>
                          </p>
                          <div className="_nitification_time"><span>42 minutes ago</span></div>
                        </div>
                      </div>
          ...
          <div className="_header_nav_profile">
            ...
            <div className={`_nav_profile_dropdown _profile_dropdown ${profileDropOpen ? 'show' : ''}`}>
