  ...
  return (
    <div className="_feed_inner_ppl_card _mar_b16">
      ...
      <div className="row">
        ...
        {[
          { img: 'card_ppl2.png', name: 'Ryan Roslansky' },
          { img: 'card_ppl3.png', name: 'Steve Jobs' },
          { img: 'card_ppl4.png', name: 'Dylan Field' },
        ].map(story => (
          <div className="col-xl-3 col-lg-3 col-md-4 col-sm-4 _custom_mobile_none" key={story.name}>
